(function() {
    ...
    angular
        .module('taptap')
        .controller('BasicLevel', BasicLevel);

    BasicLevel.$inject = ['$scope', '$routeParams', 'playService', 'staffService', 'metService', 'inputService', 'outputService', 'feedbackService', 'evaluatorService', 'focus'];

    function BasicLevel($scope, $routeParams, staffService, metService, inputService, feedbackService, evaluatorService, focus) {
        let vm = this;
